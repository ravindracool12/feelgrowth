(function($) {
    ...
    function subMenuToggle() {
        if (iOS == true) {
            $('body').on('touchstart', '.header--sidebar .menu .menu-item-has-children > .sub-toggle', function(event) {
            ...
            $('body').on('touchstart', '.header--left .menu--sidebar .menu-item-has-children > .sub-toggle', function(event) {
                event.preventDefault();
                var current = $(this).parent('.menu-item-has-children')
                current.children('.sub-menu').slideToggle(350);
                current.siblings().find('.sub-menu').slideUp(350);
            });
            $('body').on('touchstart', '.header--2 .menu--2 .menu-item-has-children > a, .header--3 .menu .menu-item-has-children > .sub-toggle', function(event) {
                event.preventDefault();
                var current = $(this).parent('.menu-item-has-children')
                current.children('.sub-menu').slideToggle(350);
                current.siblings().find('.sub-menu').slideUp(350);
            ...
            $('body').on('click', '.header--sidebar .menu .menu-item-has-children > .sub-toggle', function(event) {
                event.preventDefault();
                var current = $(this).parent('.menu-item-has-children')
                current.children('.sub-menu').slideToggle(350);
                current.children('.mega-menu').slideToggle(350);
            ...
            $('body').on('click', '.header--left .menu--sidebar .menu-item-has-children > .sub-toggle', function(event) {
                event.preventDefault();
                var current = $(this).parent('.menu-item-has-children')
                current.children('.sub-menu').slideToggle(350);
                current.siblings().find('.sub-menu').slideUp(350);
            });
            $('body').on('click', '.header--2 .menu--2 .menu-item-has-children > a, .header--3 .menu .menu-item-has-children > .sub-toggle', function(event) {
                event.preventDefault();
                var current = $(this).parent('.menu-item-has-children')
                current.children('.sub-menu').slideToggle(350);
                current.siblings().find('.sub-menu').slideUp(350);
    ...
    function resizeHeader() {
        ...
        if (checkPoint > windowWidth) {
            ...
            $('<span class="sub-toggle"><i class="fa fa-angle-down"></i></span>').prependTo(' .main-menu .dropdown');
    ...
    function productLightbox() {
        $('.ps-product--detail .ps-product__image').lightGallery({
            selector: '.item a',
            thumbnail: true
        });
